...
class Maze:
    ...
    def __draw_cell(self, column, row):
                x1 = column * self.__cell_size_x + self.__x1
    ...
    def __break_walls_r(self, i, j):
         ...
         while True:
            ...
            if len(needVisit) == 0:
                 ...
                 directionIndex = random.randrange(len(needVisit))
                 nextIndex = needVisit[directionIndex]
                ...
                # Up
                 ...
                 self.__break_walls_r(nextIndex[0], nextIndex[1])
